...
<div class="card mb-4">
    ...
    <div class="card-body">
        <form action="<c:url value="/admin_account/edit_handler.do" />">
            <div class="mb-3 mt-3">
            ...
            <div class="mb-3">
                ...
                <input type="hidden" name="email_old" value="${accOld.email}">
                <i style="color: red;">${messageEmail}</i>
            </div>
            <div class="mb-3">
                <label for="password" class="form-label">Password: </label>
                <input type="text" class="form-control" placeholder="Enter account password" name="password" value="${acc.password}">
            </div>
            <div class="mb-3">
