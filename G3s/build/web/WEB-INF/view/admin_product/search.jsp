    ...
    <div class="card-body">  
        <div class="datatable-top"> 
            ...
            <div class="datatable-search">
                <input class="datatable-input me-5" name="searchInputAdmin" id="searchInputAdmin" value="${keyword}" placeholder="Search..." type="search" title="Search within table">
            </div>
        </div>
                ...
                <tbody>
                    <c:forEach var="product" items="${listPaging}">
                        <tr>
                            ...
                            <td><img src="<c:url value="/img/${product.image}"/>" width="90px" height="90px" style="object-fit: cover;"></td>
                            <td>
                    ...
                    <ul class="datatable-pagination-list">
                        <c:forEach begin="1" end="${endPage}" var="i">
                            <li class="datatable-pagination-list-item datatable-active">
                                <a class="${i == indexPage ? "btn btn-secondary" : "btn-secondary"}" href="<c:url value="/admin_product/search.do?indexPage=${i}&keyword=${keyword}"/>" class="btn btn-secondary datatable-pagination-list-item-link">${i}</a>
                            </li>
                        </c:forEach>
                    </ul>
                </nav>
